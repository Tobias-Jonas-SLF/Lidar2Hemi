function hpol = polar_special(varargin)
...
%                'handlevisibility','off','parent',cax)
    ...
    % annotate spokes in degrees
        ...
        for i = 1:length(th)
          switch i
          case 3
            text(rt*cst(i),rt*snt(i),'S',...
                 'horizontalalignment','center',...
                 'handlevisibility','off','parent',cax);
            text(-rt*cst(i),-rt*snt(i),'N','horizontalalignment','center',...
                 'handlevisibility','off','parent',cax)
          case 6
            text(rt*cst(i),rt*snt(i),'W',...
                 'horizontalalignment','center',...
                 'handlevisibility','off','parent',cax);
            text(-rt*cst(i),-rt*snt(i),'E',...
                 'horizontalalignment','center',...
                 'handlevisibility','off','parent',cax)
          otherwise
            text(rt*cst(i),rt*snt(i),int2str(i*30+90),...
                 'horizontalalignment','center',...
                 'handlevisibility','off','parent',cax);
            text(-rt*cst(i),-rt*snt(i),int2str(mod(i*30+270,360)),...
                 'horizontalalignment','center',...
                 'handlevisibility','off','parent',cax)
          end;
        end
...
elseif strcmp(line_style,'forced')
    q = plot(xx,yy,'parent',cax,'marker','o','linestyle','none','markerfacecolor',markercolor,'markeredgecolor',markeredgecolor,'markersize',markersize);
else
